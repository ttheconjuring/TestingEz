...
public class TestingEzApplication {
    ...
    /*
     * TODO:
     *   1.Implement logic behind button 'Delete Account'.
     *   2.Implement logic behind button 'change' (avatar).
     *   3.Find out why login is required after username change.
     *   4.Implement logic behind link 'All Users'
     *   5.Make it possible to change the response time and passing score of a test
     *      and also to add a new questions.
